...
import pubCommand from "./cmds/dler/pub/cmd";
import pubOnboardCommand from "./cmds/dler/pub/onboard/cmd";
        ...
        schema: {
            properties: {
                dler: {
                    ...
                    description:
                        "Configuration consumed by @reliverse/dler-rse-plugin.",
                    properties: {
                        publishOrder: {
                            type: "array",
                            description:

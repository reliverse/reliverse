...
export declare namespace StandardSchemaV1 {
  export interface Props<TInput = unknown, TOutput = TInput> extends StandardTypedV1.Props<
    TInput,
    TOutput
  > {
    readonly validate: (
  ...
  export interface Types<TInput = unknown, TOutput = TInput> extends StandardTypedV1.Types<
    TInput,
    TOutput
  > {}

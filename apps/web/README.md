...
1. [Use this template](https://github.com/new?template_name=react-reliverse&template_owner=reliverse) or clone this repository with gitpick:

   ```bash
   npx gitpick reliverse/react-reliverse myapp
   cd myapp
   ```
